...
public class DriveSubsystem extends SubsystemBase {
   // Put methods for controlling this subsystem
	...
	//RobotContainer has CANBus ports
	
	Victor frontRight = new Victor(RobotContainer.frontRight);
	Victor frontLeft = new Victor(RobotContainer.frontLeft);
	Victor backRight = new Victor(RobotContainer.backRight);
	Victor backLeft = new Victor(RobotContainer.backLeft);
	...
	// Digital input ports can be found on RobotContainer
	...
	Encoder leftEnc = new Encoder(RobotContainer.leftEnc1, RobotContainer.leftEnc2, false, 
		Encoder.EncodingType.k4X);
	Encoder rightEnc = new Encoder(RobotContainer.rightEnc1, RobotContainer.rightEnc2, false, 
		Encoder.EncodingType.k4X);
