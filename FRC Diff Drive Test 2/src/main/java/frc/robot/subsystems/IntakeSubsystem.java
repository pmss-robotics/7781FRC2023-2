...
public class IntakeSubsystem extends SubsystemBase {
  ...
  //Digital input ports are in RobotContainer

  Ultrasonic sonic = new Ultrasonic(RobotContainer.ping, RobotContainer.echo);

  // Instantiation of speed controllers
  //CANBus port numbers are in RobotContainer

  Victor intakeRight = new Victor(RobotContainer.intake1);
  Victor intakeLeft = new Victor(RobotContainer.intake2);
